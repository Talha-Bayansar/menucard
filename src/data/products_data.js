...
export const PRODUCTS_DATA = [
  {
    ...
    subcategories: [
        ...
        products: [
          {
            ...
            info:
              "Bavik Super Pils heeft zijn unieke smaak en aroma te danken aan zijn bijzondere brouwproces. " +
              "Onze pils wordt tijdens het brouwproces niet verdund waardoor we een volmondige smaak garanderen. " +
              "Bovendien gebruiken we enkel aromahoppen wat zorgtvoor een verfijnde bittere smaak en een verfrissend aroma. " +
          ...
          },
          {
            ...
            info:
              "LA CHOUFFE leaves citrus notes on the palate, followed by a refreshing, pleasantly spicy note, " +
              "giving it a lovely lightness. With its 8% alcohol content and slightly hoppy taste, " +
              "this golden beer has won over beer lovers from allover the world down the years. Its unique taste has won various awards.",
          },
          {
            id: "La Chouffe large",
            name: "La Chouffe",
          ...
          },
          {
            ...
            info:
              ...
              "Every drop as thirst-quenching as the last, VedettIPA offers an explosion of flavoursome bitterness that increases with intensity towards the finish, " +
              "tempered by an unparalleled velvety smoothness resulting in a very accessible taste. " +
              "Fresh, fruity and floral notes give way to touchesof caramel sweetness, " +
              "hile its superb, lingering aftertaste continues totantalise the tastebuds long after. " +
              "Here’s to a great-tasting, refreshing beer!",
          },
          {
            id: "Gouden Carolus Tripel",
            ...
            brewery: "Het Anker",
            info:
              "Despite the technological advances, this beer isbrewed according to ancient tradition and unites, as before, " +
              "the best raw materials from our soil as ripe barley and fine hops, to preserve a maximum of pure flavor. " +
              "This beer was originally brewed for the Knights ofthe Golden Fleece in 1491. " +
      ...
      },
      {
        name: "Craft",
        note:
          "We werken samen met ambachtelijke brouwerijen, die maar een bepaalde hoeveelheid kunnen produceren. Sommige bieren kunnen hierdoor tijdelijk uit stock zijn.",
        products: [
          {
            id: "Antigoon",
            name: "Antigoon",
          ...
          },
          {
            ...
            brewery: "Brouwerij De Brabandere",
            info:
              "Eigenwieze Wieze... Bier, dat moet voor ons geentoeters of bellen hebben – maar wel ballen. " +
    ...
    subcategories: [
      {
        ...
        products: [
          ...
          {
            id: "Tripcal Mango and Pineapple",
            name: "Tripcal Mango and Pineapple",
            price: 3.5,
          },
        ],
      },
  ...
  },
  {
    ...
    note:
      "Bij ons kan je ook heel lekker eten. Van kleine snacks tot mooiebrunches. ‘s Avonds kan je terecht voor onze Macaroni’s, ’s middags serveren we je ovenverse croques met een twist.",
    subcategories: [
      {
        name: "Croques",
        note: "Alle croques worden vergezeld door een slaatje",
        products: [
          {
            id: "Camille",
            name: "Camille",
            price: 12,
            note:
              "Camembert, walnoten, rode ui en augurk, vergezeld van een krielslaatje.",
          },
          {
            id: "Geike",
            name: "Geike",
            price: 12,
            note:
              "Geitenkaas, spinazie, groene appel, groene pesto, vergezeld van een krielslaatje.",
          },
          {
            id: "Brienne",
            name: "Brienne",
            price: 12,
            note:
              "Brie, walnoten, honing, rucola, vergezeld van een krielslaatje.",
          },
          {
            id: "Caesar",
            name: "Caesar",
            price: 12,
            note:
              "Gerookte kip, groene pesto, rode ui, tomaat, caesar dressing en rucola, vergezeld van een krielslaatje.",
          },
          {
            id: "Otto-Kaas Ham",
            name: "Otto-Kaas Ham",
            price: 13.5,
            note: "Gouda, ham, augurk",
          },
          {
            id: "Mozart",
            name: "Mozart",
            price: 10.5,
            note:
              "Mozzarella, basilicum, parmaham, vergezeld van een krielslaatje.\n",
          },
        ],
      },
      {
        ...
        products: [
          ...
          { id: "Vleesplank + brood", name: "Vleesplank + brood", price: 8 },
          {
            ...
            name: "Chips",
            price: 2,
            note: "Paprika, Zout, Grills, Bolognaise",
          },
        ],
      },
      {
